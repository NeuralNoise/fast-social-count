...
function fsc_add_stylesheets() {
    $version = "1.5";
    wp_register_style('fast_social_count_css', plugins_url('/assets/fast-social-count.min.css', __FILE__),'',$version, false);
...
function fast_social($atts){
    ...
    wp_register_script('fast_social_count_js', plugins_url('/assets/fast_social_count.min.js', __FILE__), array('jquery'),$version, true);
